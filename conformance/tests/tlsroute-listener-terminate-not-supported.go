...
var TLSRouteListenerTerminateNotSupported = suitepkg.ConformanceTest{
	...
	Test: func(t *testing.T, suite *suitepkg.ConformanceTestSuite) {
		...
		gwNN := types.NamespacedName{Name: "gateway-tlsroute-terminate-unsupported", Namespace: suitepkg.InfrastructureNamespace}
