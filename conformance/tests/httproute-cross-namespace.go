...
var HTTPRouteCrossNamespace = suitepkg.ConformanceTest{
	...
	Test: func(t *testing.T, suite *suitepkg.ConformanceTestSuite) {
		routeNN := types.NamespacedName{Name: "cross-namespace", Namespace: suitepkg.WebBackendNamespace}
		gwNN := types.NamespacedName{Name: "backend-namespaces", Namespace: suitepkg.InfrastructureNamespace}
