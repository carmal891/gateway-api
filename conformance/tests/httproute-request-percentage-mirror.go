...
var HTTPRouteRequestPercentageMirror = suitepkg.ConformanceTest{
...
func testMirroredRequestsDistribution(t *testing.T, suite *suitepkg.ConformanceTestSuite, expected http.ExpectedResponse, timeVal time.Time) error {
