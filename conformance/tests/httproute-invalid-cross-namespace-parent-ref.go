...
var HTTPRouteInvalidCrossNamespaceParentRef = suitepkg.ConformanceTest{
	...
	Test: func(t *testing.T, suite *suitepkg.ConformanceTestSuite) {
		...
		routeNN := types.NamespacedName{Name: "invalid-cross-namespace-parent-ref", Namespace: suitepkg.WebBackendNamespace}
