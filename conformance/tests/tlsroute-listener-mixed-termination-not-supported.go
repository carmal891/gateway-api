...
var TLSRouteListenerMixedTerminationNotSupported = suitepkg.ConformanceTest{
	...
	Test: func(t *testing.T, suite *suitepkg.ConformanceTestSuite) {
		...
		gwNN := types.NamespacedName{Name: "gateway-tlsroute-mixed-termination-not-supported", Namespace: suitepkg.InfrastructureNamespace}
