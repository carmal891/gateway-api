...
var TLSRouteListenerTerminateSupportedKinds = suitepkg.ConformanceTest{
	...
	Test: func(t *testing.T, suite *suitepkg.ConformanceTestSuite) {
		gwNN := types.NamespacedName{Name: "gateway-tlsroute-terminate-supported", Namespace: suitepkg.InfrastructureNamespace}
