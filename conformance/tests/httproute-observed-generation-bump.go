...
var HTTPRouteObservedGenerationBump = suitepkg.ConformanceTest{
	...
	Test: func(t *testing.T, s *suitepkg.ConformanceTestSuite) {
		routeNN := types.NamespacedName{Name: "observed-generation-bump", Namespace: suitepkg.InfrastructureNamespace}
		gwNN := types.NamespacedName{Name: "same-namespace", Namespace: suitepkg.InfrastructureNamespace}
